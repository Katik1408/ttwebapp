...
import java from "../../../Assets/Course/Java_Course.jpg"
               ...
               <div className="dataScienceDescSection container my-3">
                  <div className="row">
                     <div className="col-md-7 courseHeading">
                        <p>
                           Ranked #1 Basic & Advance Java Course Online Training Course with Certifications.
                        </p>
                        <p>
                           This Basic & Advance Java Course online Training and Certification Course will help you master in all aspects including Basic statistics, Python, Machine Learning, SQL, Excel, AI, Tableau, Hadoop, and Spark with Hands-on Classes.
                        </p>
                        <p>
                           Learn Basic & Advance Java Course Online Training Course from India’s #1 Certification Oriented Data Science Online Training institute with IBM Certified Trainers, Real World projects and 100% assured placement support, all designed to help you become Become highly skilled and qualified data scientist.
                        </p>
                     ...
                     <div className="col-md-5">
                        <div className="courseShowCase">
                           <div className="courseImgSec">
                              <img src={java} className="courseImg" alt="" />
                           </div>
                           <div className="courseMode text-center">
                              Basic & Advance Java Course
                           </div>
                           <div className="coursePrice text-center py-2">
                              <span className="priceTag">Price</span>&nbsp;&nbsp;<span className="offerPrice">&#8377;30000</span> <span className="acctualPrice">&#8377;35000</span>
                           </div>
               ...
               <div className="aboutDataScienceSection">
                  ...
                  <div className="courseDesc container">
                     <div className="contentSubHeading my-3" id="aboutDescSec">
                        About Basic & Advance Java Course
                     ...
                     <div className="aboutDescSec">
                        <div className="sec1">
                           <div className="row">
                              <p>
                                 Basic & Advance Java Course Online Training will help you to become an expert in Probability and Statistics, Excel, SQL, Tableau,
                     ...
                     <div className="contentSubHeading my-4" id="syllabus">
                        Syllabus Of Basic & Advance Java Course
                        <img src={ul} alt="UnderLine" />
                     </div>
                     ...
                     <div className="contentSubHeading my-4" id="commingBatch">
                        Upcoming Batch of Basic & Advance Java Course
                        <img src={ul} alt="UnderLine" />
                     </div>
                     ...
                     <div className="contentSubHeading my-4" id="trainerProfile">
                        Trainer Profile of Basic & Advance Java Course
                        <img src={ul} alt="UnderLine" />
                     </div>
                     <div className="trainerDescSec">
                        <div className="trainerDetails">
                           ...
                           <div className="trainerSpecialist">
                              Specialist In : Basic & Advance In Java
                           </div>
                           <div className="lang">
                        ...
                        <div className="trainerDesc">
                           <p>
                              Karthik has worked for 7 years as a Data Science Trainer, collaborating with many professionals from different backgrounds.
                           </p>
                           <p>
                     ...
                     <div className="contentSubHeading my-4" id="certification">
                        Certification of Basic & Advance Java Course
                        <img src={ul} alt="UnderLine" />
                     </div>
                     ...
                     <div className="contentSubHeading my-4" id="keyFeature">
                        Key Features of Basic & Advance Java Course
                        <img src={ul} alt="UnderLine" />
                     </div>
                     ...
                     <div className="contentSubHeading my-4" id="faq">
                        FAQ's of Basic & Advance Java Course
                        <img src={ul} alt="UnderLine" />
                     </div>
