               ...
               <div className="dataScienceDescSection container my-3">
                  <div className="row">
                     <div className="col-md-7 courseHeading">
                        <p>
                           Ranked #1 MEAN Stack Online Training Course with Certifications.
                        </p>
                        <p>
                           This MEAN Stack online Training and Certification Course will help you master in all aspects including Basic statistics, Python, Machine Learning, SQL, Excel, AI, Tableau, Hadoop, and Spark with Hands-on Classes.
                        </p>
                        <p>
                           Learn MEAN Stack Online Training Course from India’s #1 Certification Oriented Data Science Online Training institute with IBM Certified Trainers, Real World projects and 100% assured placement support, all designed to help you become Become highly skilled and qualified data scientist.
                        </p>
                     ...
                     <div className="col-md-5">
                        <div className="courseShowCase">
                           <div className="courseImgSec">
                              <img src={mean} className="courseImg" alt="" />
                           </div>
                           <div className="courseMode text-center">
                              MEAN Stack Course
                           </div>
                           <div className="coursePrice text-center py-2">
                              <span className="priceTag">Price</span>&nbsp;&nbsp;<span className="offerPrice">&#8377;27000</span> <span className="acctualPrice">&#8377;32000</span>
                           </div>
                  ...
                  <div className="courseDesc container">
                     ...
                     <div className="aboutDescSec">
                        <div className="sec1">
                           <div className="row">
                              <p>
                                 MEAN Stack Course Online Training will help you to become an expert in Probability and Statistics, Excel, SQL, Tableau,
                     ...
                     <div className="contentSubHeading my-4" id="commingBatch">
                        Upcoming Batch of MEAN Stack Course
                        <img src={ul} alt="UnderLine" />
                     </div>
                     ...
                     <div className="contentSubHeading my-4" id="trainerProfile">
                        Trainer Profile of MEAN Stack Course
                        <img src={ul} alt="UnderLine" />
                     </div>
                     <div className="trainerDescSec">
                        <div className="trainerDetails">
                           ...
                           <div className="trainerSpecialist">
                              Specialist In : Angular, Express.js, Node.js, MongoDB
                           </div>
                           <div className="lang">
                     ...
                     <div className="contentSubHeading my-4" id="certification">
                        Certification of MEAN Stack Course
                        <img src={ul} alt="UnderLine" />
                     </div>
                     ...
                     <div className="contentSubHeading my-4" id="keyFeature">
                        Key Features of MEAN Stack Course
                        <img src={ul} alt="UnderLine" />
                     </div>
