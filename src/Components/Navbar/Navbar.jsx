...
import logo from "../../Assets/Logo/TechnoTutorIcon.png"
      ...
      <>
         <div className="navbarSection">
            ...
            <div className="marqueeSec">
               <div className="marqueeContainer container">
                  <Marquee>&nbsp;&nbsp;&nbsp;100% Interview Call Guarantee&nbsp;&nbsp;&nbsp;<GiNinjaStar />&nbsp;&nbsp;&nbsp;Lifetime placement support&nbsp;&nbsp;&nbsp;<GiNinjaStar />&nbsp;&nbsp;&nbsp;Advanced project based Training&nbsp;&nbsp;&nbsp;<GiNinjaStar />&nbsp;&nbsp;&nbsp;Learn at your pace with integrated LMS&nbsp;&nbsp;&nbsp;<GiNinjaStar />&nbsp;&nbsp;&nbsp;30+ Latest in demand tools and technologies&nbsp;&nbsp;&nbsp;<GiNinjaStar />&nbsp;&nbsp;&nbsp;Experienced Corporate Trainers&nbsp;&nbsp;&nbsp;<GiNinjaStar /></Marquee>
               </div>
            </div>
         </div>
      </>
